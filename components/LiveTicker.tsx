...
const STATIC_DATA: MarketPulse = {
  mortgage30:  { value: 6.87, label: '30-YR FIXED',       suffix: '%',  source: 'Freddie Mac' },
  vacancy:     { value: 6.1,  label: 'RENTAL VACANCY',    suffix: '%',  source: 'Census' },
  cpi:         { value: 3.2,  label: 'CPI YoY',           suffix: '%',  source: 'BLS' },
  fedFunds:    { value: 4.33, label: 'FED FUNDS',         suffix: '%',  source: 'Fed Reserve' },
  medianRent:  { value: 1844, label: 'MEDIAN RENT',       suffix: '',   prefix: '$', source: 'Census ACS' },
  rentGrowth:  { value: 2.8,  label: 'RENT GROWTH YoY',  suffix: '%',  source: 'CoStar' },
...
function TickerItem({ metric, loading }: { metric: Metric; loading: boolean }) {
  return (
    <div style={{
      ...
      padding: '10px 20px', borderRight: '1px solid rgba(255,255,255,0.06)',
      flexShrink: 0, minWidth: 120,
    }}>
      <div style={{
        fontFamily: "'Cormorant Garamond', Georgia, serif",
        fontSize: 22, fontWeight: 700,
        color: loading ? 'rgba(45,212,191,0.4)' : 'var(--teal)',
      ...
      {metric.source && (
        <div style={{
          fontFamily: "'JetBrains Mono', monospace",
          fontSize: 8, color: 'rgba(139,149,163,0.5)', letterSpacing: '0.06em',
        }}>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: loading
          ? 'linear-gradient(90deg, var(--teal) 0%, transparent 60%)'
          : 'linear-gradient(90deg, var(--teal) 0%, var(--teal2) 50%, transparent 100%)',
        opacity: loading ? 0.5 : 0.3,
      }} />
      ...
      <div style={{
        ...
        <div style={{
          ...
          padding: '10px 20px 10px 0', borderRight: '1px solid rgba(45,212,191,0.2)',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
            <span style={{
              ...
              boxShadow: loading ? 'none' : '0 0 6px var(--green)',
              flexShrink: 0,
            }} />
            <span style={{
              fontFamily: "'JetBrains Mono', monospace",
              fontSize: 8, color: loading ? 'var(--muted)' : 'var(--green)',
              letterSpacing: '0.1em',
            }}>
